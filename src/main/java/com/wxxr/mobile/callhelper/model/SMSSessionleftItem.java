...
@View(name = "SMSSessionleftItem")
@AndroidBinding(type=AndroidBindingType.VIEW,layoutId="R.layout.sms_detail_item_left")
public class SMSSessionleftItem extends ViewBase implements IModelUpdater{
